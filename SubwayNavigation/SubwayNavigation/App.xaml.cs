    ...
    public partial class App : Application
    {
        public App()
        {
            ...
            var stationList = new List<SubwayStation> { 
                ...
                new SubwayStation{Name = "Politekhnichnyi instytut", Number=7, BrachLine = redBranch, X = xOffset+=4, Y = yOffset+=3},
                ...
                new SubwayStation{Name = "Heroiv Dnipra", Number=19, BrachLine = blueBranch, X = xOffset=50, Y = yOffset=7},
                ...
                new SubwayStation{Name = "Tarasa Shevchenka", Number=23, BrachLine = blueBranch, X = xOffset, Y = yOffset+=4},
                new SubwayStation{Name = "Kontractova Ploshcha", Number=24, BrachLine = blueBranch, X = xOffset, Y = yOffset+=4},
                new SubwayStation{Name = "Pocschtova Ploshcha", Number=25, BrachLine = blueBranch, X = xOffset, Y = yOffset+=4},
                new SubwayStation{Name = "Maidan Nezalezhnosti", Number=26, BrachLine = blueBranch, X = xOffset, Y = yOffset+=4},
                new SubwayStation{Name = "Ploshcha Lva Tolstoho", Number=27, BrachLine = blueBranch, X = xOffset-=5, Y = yOffset+=10},
                new SubwayStation{Name = "Olimpiiska", Number=28, BrachLine = blueBranch, X = xOffset-=4, Y = yOffset+=7},
                new SubwayStation{Name = "Palats Ukraina", Number=29, BrachLine = blueBranch, X = xOffset, Y = yOffset+=6},
                ...
                new SubwayStation{Name = "Vystavkovyi Tsentr", Number=34, BrachLine = blueBranch, X = xOffset-=4, Y = yOffset+=5},
                ...
                new SubwayStation{Name = "Zoloti Vorota", Number=40, BrachLine = greenBranch, X = xOffset+=4, Y = yOffset+=7},
                new SubwayStation{Name = "Palats Sportu", Number=41, BrachLine = greenBranch, X = xOffset+=6, Y = yOffset+=10},
                ...
                new SubwayStation{Name = "Druzhby Narodiv", Number=44, BrachLine = greenBranch, X = xOffset, Y = yOffset+=6},
                ...
                new SubwayStation{Name = "Chervonyi Khutir", Number=52, BrachLine = greenBranch, X = xOffset+=4, Y = yOffset-=4},
            };
